(function() {
    ...
    function processMarkdown(content) {
        ...
        content = content
            .replace(/###HEADER1###(.*?)###HEADER1###/g, '<h3 style="color: #153b2b; margin-top: 20px; margin-bottom: 10px; font-weight: 600;">$1</h3>')
            .replace(/###HEADER2###(.*?)###HEADER2###/g, '<h4 style="color: #1f4f39; margin-top: 15px; margin-bottom: 8px; font-weight: 600;">$1</h4>')
